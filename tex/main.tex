...
Following the definitions of Currying (2.7.2.3), we can transform $\U{5}^\U{3}
\times \U{3} \to \U{5}$ to $Hom_{Set}(\U{3},\U{5}) \to Hom_{Set}(\U{3},\U{5})$.
There is an canonical function $id_{Hom_{Set}(\U{3},\U{5})}$ mapping every $\U{3}
\to \U{5}$ function to itself.
