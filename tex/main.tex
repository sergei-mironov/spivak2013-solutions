...
$X \sqcup_W Y = \set{..., -2, -1, \Laughey}$ where $\Laughey$ is an equivalence class for
all $\set{\Laughey, 0, 1, 2, ...}$.
...
Let $X = R$ be the set of real numbers. What is the coequalizer of the
two maps $X \to X$ given by $x \mapsto x$ and $x \mapsto (x + 1)$ respectively?
